...
\chapterNote{Conversa informal entre Ajahn Chah, um médico e sua esposa.}
\chapter{Conversa com um doutor}
\tocChapterNote{Conversa informal entre Ajahn Chah, um médico e sua esposa.}
\markright{\theChapterAuthor}

\speaker{Dr.} -- Tanto quanto me lembro de ter lido uma vez, havia
...
\textit{Akāliko} – morte tem dia e hora? Se aquela pessoa vê dessa
...
\textit{piṇḍapāta}, mas minha esposa doa todos os dias pela manhã. Eu
...
\speaker{esposa do Dr.} -- Eu sinto que me faz feliz, quando doo
\textit{piṇḍapāta} fico feliz.

\speaker{Ajahn Chah} -- Pode deixar, eu vou explicar, vou resolver
...
pessoa que tem fé profunda tem que doar \textit{piṇḍapāta} ou fazer
...
\textit{piṇḍapāta} à toa, sem noção de nada, eu concordo contigo, mas
