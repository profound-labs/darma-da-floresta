...
vergonha, medo. Vergonha e medo transformam-se em \textit{s\=\ila}
...
Sakad\=ag\=ami, An\=ag\=am\=\i, Arahant.} Esses são nomes de pessoas
...
“\textit{s\=\ila samvara”}. \textit{S\=\ila }é aquilo que controla,
para que tenha medo, vergonha, até se desenvolver e não querer mais
fazer o que é ruim, o que não é bom, graças à \textit{s\=\ila. S\=\ila}
...
medo e vergonha, são a totalidade de \textit{s\=\ila}. Quer seja
\textit{s\=\ila }de monge, noviço, leigo, todas as formas de
\textit{s\=\ila}. Se não tiver vergonha e medo, fica tudo sujo. 

Portanto, aqueles que são sábios não sentem dificuldade em observar
\textit{s\=\ila}. Se não entendemos \textit{s\=\ila,} sentimos
...
sábios observam \textit{s\=\ila} resguardando suas mentes para que
sejam dessa forma normalmente e pronto, isso já é \textit{s\=\ila} por
completo. Já é \textit{s\=\ila}. Portanto, quando a prática chega ao
nível mais alto, a prática de \textit{s\=\ila} se refina ainda mais, o
...
\textit{s\=\ila} impecável, e pedir tutela a ele. Esse é o modo de
...
\textit{s\=\ila}. A mesma coisa para nós praticando o \textit{uposatha}
...
palavras “somut” ([E2A?][E21?][E38?][E14?]) e “vimut”
([E27?][E34?][E21?][E38?][E15?]), pode ser interpretado como “o
...
Sakad\=ag\=ami, An\=ag\=am\=\i, Arahant, }etc. Essas são manifestações
...
separadas. Por que o Buda separou em \textit{s\=\ila, sam\=adhi,
paññ\=a}? Separou para que os que estudam a teoria aprendam fácil,
entendam fácil. Essa característica se chama \textit{s\=\ila}, essa
\textit{sam\=adhi} e essa \textit{paññ\=a}. Mas na verdade
\textit{s\=\ila, sam\=adhi, paññ\=a }são a mesma coisa. São o mesmo,
...
\textit{s\=\ila, sam\=adhi, paññ\=a. S\=\ila, sam\=adhi, paññ\=a }são
um mesmo corpo. Se são um mesmo corpo, fica difícil estudar a teoria,
então separam: corpo e fala são \textit{s\=\ila}, mente é
...
\textit{s\=\ila}. Esse é o começo de tudo, tem que virar comportamento.
...
unificar a mente, isso se chama \textit{samvara-s\=\ila}:\textit{
