...
correto, \textit{s\=\ila, sam\=adhi, paññ\=a}, todos falam muito
...
É algo parecido com a área da \textit{s\=\im\=a}\footnote{É uma área
...
etc.}: em qualquer lugar pode haver \textit{s\=\im\=a} se a pessoa
souber enxergar as características da \textit{s\=\im\=a}. Pode ser na
...
\textit{s\=\ila}, segurar \textit{sam\=adhi}, segurar \textit{paññ\=a}
...
praticam \textit{samath\=a} ou \textit{vipassan\=a}?” Acho difícil
...
essa faca tem tanto afiado e cego. Você pratica \textit{samath\=a} ou
\textit{vipassan\=a}? Eu acho difícil responder, porque ambos estão
...
\textit{samath\=a}, quer dizer paz, essa paz é por ter se isolado dos
